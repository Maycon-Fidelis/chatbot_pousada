...
from reserva import carregar_reservas, verificar_disponibilidade, adicionar_reserva
                ...
                if dados["action"] == "reserva":
                    ...
                    if disponibilidade:
                        nova_reserva = {
                            ...
                            'HospedeNome': 'Cliente',
                            'HospedeContato': 'Desconhecido',
                            'DataEntrada': dados["data_entrada"],
                            'DataSaida': dados["data_saida"],
                            'TipoQuarto': dados["tipo_quarto"],
                            'StatusReserva': 'Confirmada',
                            'NumeroPessoas': '1',
                            'ValorTotal': '0.00',
                            'DataReserva': str(datetime.now().date()),
                            'Notas': 'Reserva gerada pelo chatbot'
                        }
